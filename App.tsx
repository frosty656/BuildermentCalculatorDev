...
export default function App() {
  ...
  useEffect(() => {
    AsyncStorage.getItem("workshopLevel").then((value) => {
      if (value != null) {
        setWorkShopLevel(parseInt(value));
      }
    });

    AsyncStorage.getItem("furnaceLevel").then((value) => {
      if (value != null) {
        setFurnaceLevel(parseInt(value));
      }
    });

    AsyncStorage.getItem("machineShopLevel").then((value) => {
      if (value != null) {
        setMachineShopLevel(parseInt(value));
      }
    });

    AsyncStorage.getItem("industrialFactoryLevel").then((value) => {
      if (value != null) {
        setIndustrialFactoryLevel(parseInt(value));
      }
    });

    AsyncStorage.getItem("forgeLevel").then((value) => {
      if (value != null) {
        setForgeLevel(parseInt(value));
      }
    });

    AsyncStorage.getItem("manufacturerLevel").then((value) => {
      if (value != null) {
        setManufacturerLevel(parseInt(value));
      }
    });

    AsyncStorage.getItem("extractorLevel").then((value) => {
      if (value != null) {
        setExtractorLevel(parseInt(value));
      }
    });
  }, []);
  ...
  useEffect(() => {
    AsyncStorage.setItem("workshopLevel", workshopLevel.toString());
    AsyncStorage.setItem("furnaceLevel", furnaceLevel.toString());
    AsyncStorage.setItem("machineShopLevel", machineShopLevel.toString());
    AsyncStorage.setItem(
      "industrialFactoryLevel",
      industrialFactoryLevel.toString()
    );
    AsyncStorage.setItem("forgeLevel", forgeLevel.toString());
    AsyncStorage.setItem("manufacturerLevel", manufacturerLevel.toString());
    AsyncStorage.setItem("extractorLevel", extractorLevel.toString());
  }, [
    workshopLevel,
    furnaceLevel,
    machineShopLevel,
